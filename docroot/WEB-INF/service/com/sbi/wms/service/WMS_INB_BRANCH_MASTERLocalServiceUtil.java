...
/**
 * The utility for the w m s_ i n b_ b r a n c h_ m a s t e r local service. This utility wraps {@link com.sbi.wms.service.impl.WMS_INB_BRANCH_MASTERLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @generated
 */
public class WMS_INB_BRANCH_MASTERLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.sbi.wms.service.impl.WMS_INB_BRANCH_MASTERLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.sbi.wms.model.WMS_INB_BRANCH_MASTER addWMS_INB_BRANCH_MASTER(
		com.sbi.wms.model.WMS_INB_BRANCH_MASTER wms_inb_branch_master)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addWMS_INB_BRANCH_MASTER(wms_inb_branch_master);
	}
	...
	*/
	public static com.sbi.wms.model.WMS_INB_BRANCH_MASTER createWMS_INB_BRANCH_MASTER(
		long REC_ID) {
		return getService().createWMS_INB_BRANCH_MASTER(REC_ID);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sbi.wms.model.WMS_INB_BRANCH_MASTER deleteWMS_INB_BRANCH_MASTER(
		long REC_ID)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteWMS_INB_BRANCH_MASTER(REC_ID);
	}
	...
	*/
	public static com.sbi.wms.model.WMS_INB_BRANCH_MASTER deleteWMS_INB_BRANCH_MASTER(
		com.sbi.wms.model.WMS_INB_BRANCH_MASTER wms_inb_branch_master)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteWMS_INB_BRANCH_MASTER(wms_inb_branch_master);
	}
	...
	*/
	...
	public static com.sbi.wms.model.WMS_INB_BRANCH_MASTER fetchWMS_INB_BRANCH_MASTER(
		long REC_ID) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchWMS_INB_BRANCH_MASTER(REC_ID);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sbi.wms.model.WMS_INB_BRANCH_MASTER getWMS_INB_BRANCH_MASTER(
		long REC_ID)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getWMS_INB_BRANCH_MASTER(REC_ID);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sbi.wms.model.WMS_INB_BRANCH_MASTER> getWMS_INB_BRANCH_MASTERs(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getWMS_INB_BRANCH_MASTERs(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getWMS_INB_BRANCH_MASTERsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getWMS_INB_BRANCH_MASTERsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sbi.wms.model.WMS_INB_BRANCH_MASTER updateWMS_INB_BRANCH_MASTER(
		com.sbi.wms.model.WMS_INB_BRANCH_MASTER wms_inb_branch_master)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateWMS_INB_BRANCH_MASTER(wms_inb_branch_master);
	}
	...
	*/
	public static com.sbi.wms.model.WMS_INB_BRANCH_MASTER updateWMS_INB_BRANCH_MASTER(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateWMS_INB_BRANCH_MASTER(wms_inb_branch_master, merge);
	}
	...
	*/
	...
	public static WMS_INB_BRANCH_MASTERLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					WMS_INB_BRANCH_MASTERLocalService.class.getName());

			if (invokableLocalService instanceof WMS_INB_BRANCH_MASTERLocalService) {
				_service = (WMS_INB_BRANCH_MASTERLocalService)invokableLocalService;
			}
			else {
				_service = new WMS_INB_BRANCH_MASTERLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(WMS_INB_BRANCH_MASTERLocalServiceUtil.class,
				"_service");
		}
	 ...
	 * @deprecated
	 */
	public void setService(WMS_INB_BRANCH_MASTERLocalService service) {
	}

	private static WMS_INB_BRANCH_MASTERLocalService _service;
}