...
/**
 * The persistence utility for the exclusif_ w m s service. This utility wraps {@link Exclusif_WMSPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class Exclusif_WMSUtil {
	 ...
	 */
	public static void clearCache(Exclusif_WMS exclusif_WMS) {
		getPersistence().clearCache(exclusif_WMS);
	}
	 ...
	 */
	public static List<Exclusif_WMS> findWithDynamicQuery(
	 ...
	 */
	public static Exclusif_WMS update(Exclusif_WMS exclusif_WMS, boolean merge)
		throws SystemException {
		return getPersistence().update(exclusif_WMS, merge);
	}
	...
	public static Exclusif_WMS update(Exclusif_WMS exclusif_WMS, boolean merge,
		...
		return getPersistence().update(exclusif_WMS, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.sbi.wms.model.Exclusif_WMS exclusif_WMS) {
		getPersistence().cacheResult(exclusif_WMS);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(exclusif_WMSs);
	}
	...
	*/
	public static com.sbi.wms.model.Exclusif_WMS create(long recId) {
	...
	*/
	public static com.sbi.wms.model.Exclusif_WMS remove(long recId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sbi.wms.NoSuchExclusif_WMSException {
		return getPersistence().remove(recId);
	}

	public static com.sbi.wms.model.Exclusif_WMS updateImpl(
		com.sbi.wms.model.Exclusif_WMS exclusif_WMS, boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(exclusif_WMS, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sbi.wms.model.Exclusif_WMS findByPrimaryKey(long recId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.sbi.wms.NoSuchExclusif_WMSException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.sbi.wms.model.Exclusif_WMS fetchByPrimaryKey(long recId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.sbi.wms.model.Exclusif_WMS> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static Exclusif_WMSPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (Exclusif_WMSPersistence)PortletBeanLocatorUtil.locate(com.sbi.wms.service.ClpSerializer.getServletContextName(),
					Exclusif_WMSPersistence.class.getName());

			ReferenceRegistry.registerReference(Exclusif_WMSUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(Exclusif_WMSPersistence persistence) {
	}

	private static Exclusif_WMSPersistence _persistence;
}