...
/**
 * The base implementation of the w m s_ i n b_ b r a n c h_ m a s t e r local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sbi.wms.service.impl.WMS_INB_BRANCH_MASTERLocalServiceImpl}.
 * </p>
 *
 * @author Syed
 * @see com.sbi.wms.service.impl.WMS_INB_BRANCH_MASTERLocalServiceImpl
 * @see com.sbi.wms.service.WMS_INB_BRANCH_MASTERLocalServiceUtil
 * @generated
 */
public abstract class WMS_INB_BRANCH_MASTERLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements WMS_INB_BRANCH_MASTERLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sbi.wms.service.WMS_INB_BRANCH_MASTERLocalServiceUtil} to access the w m s_ i n b_ b r a n c h_ m a s t e r local service.
	 */
	...
	public WMS_INB_BRANCH_MASTER addWMS_INB_BRANCH_MASTER(
		WMS_INB_BRANCH_MASTER wms_inb_branch_master) throws SystemException {
		wms_inb_branch_master.setNew(true);

		return wms_inb_branch_masterPersistence.update(wms_inb_branch_master,
			false);
	}
	 ...
	 */
	public WMS_INB_BRANCH_MASTER createWMS_INB_BRANCH_MASTER(long REC_ID) {
		return wms_inb_branch_masterPersistence.create(REC_ID);
	}
	...
	public WMS_INB_BRANCH_MASTER deleteWMS_INB_BRANCH_MASTER(long REC_ID)
		throws PortalException, SystemException {
		return wms_inb_branch_masterPersistence.remove(REC_ID);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public WMS_INB_BRANCH_MASTER deleteWMS_INB_BRANCH_MASTER(
		WMS_INB_BRANCH_MASTER wms_inb_branch_master) throws SystemException {
		return wms_inb_branch_masterPersistence.remove(wms_inb_branch_master);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(WMS_INB_BRANCH_MASTER.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return wms_inb_branch_masterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return wms_inb_branch_masterPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public WMS_INB_BRANCH_MASTER fetchWMS_INB_BRANCH_MASTER(long REC_ID)
		throws SystemException {
		return wms_inb_branch_masterPersistence.fetchByPrimaryKey(REC_ID);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public WMS_INB_BRANCH_MASTER getWMS_INB_BRANCH_MASTER(long REC_ID)
		throws PortalException, SystemException {
		return wms_inb_branch_masterPersistence.findByPrimaryKey(REC_ID);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return wms_inb_branch_masterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<WMS_INB_BRANCH_MASTER> getWMS_INB_BRANCH_MASTERs(int start,
		int end) throws SystemException {
		return wms_inb_branch_masterPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getWMS_INB_BRANCH_MASTERsCount() throws SystemException {
		return wms_inb_branch_masterPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public WMS_INB_BRANCH_MASTER updateWMS_INB_BRANCH_MASTER(
		WMS_INB_BRANCH_MASTER wms_inb_branch_master) throws SystemException {
		return updateWMS_INB_BRANCH_MASTER(wms_inb_branch_master, true);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.sbi.wms.model.WMS_INB_BRANCH_MASTER",
			wms_inb_branch_masterLocalService);
	}
	...
	private WMS_INB_BRANCH_MASTERLocalServiceClpInvoker _clpInvoker = new WMS_INB_BRANCH_MASTERLocalServiceClpInvoker();
}